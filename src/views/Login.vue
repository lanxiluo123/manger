        ...
        <form @submit.prevent="handleLogin" class="login-form">
          <div class="form-group" :class="{ 'error': errors.username }">
            ...
            <div class="input-container">
              ...
              <input type="text" id="username" v-model="form.username" placeholder="请输入用户名" @blur="validateField('username')">
            </div>
          ...
          <div class="form-group" :class="{ 'error': errors.password }">
            ...
            <div class="input-container">
              ...
              <input :type="showPassword ? 'text' : 'password'" id="password" v-model="form.password" placeholder="请输入密码" @blur="validateField('password')">
