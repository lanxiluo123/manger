            ...
            <el-row :gutter="20">
                <el-col :span="12">
                    <el-form-item label="流域名称">
                        <el-input v-model="form.name" placeholder="流域名称" />
                    </el-form-item>
                </el-col>
                <el-col :span="12">
                    <el-form-item label="流域编码">
                        <el-input v-model="form.code" placeholder="流域编码" />
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row :gutter="20">
            ...
            <el-row :gutter="20">
                <el-col :span="24">
                    <el-form-item label="负责人">
                        <el-input v-model="form.manager" placeholder="负责人" />
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row :gutter="20">
...
async function onSubmit() {
    if (!form.id) {
        try {
            ...
            await addApi({
                parentCode: parentCode == 'all' ? undefined : parentCode,
                minX: Number(minX),
                minY: Number(minY),
                maxX: Number(maxX),
                maxY: Number(maxY),
        ...
        try {
            const { id, parentCode, ...options } = form
            await editApi({
                id,
                parentCode: parentCode == 'all' ? undefined : parentCode,
                ...options
